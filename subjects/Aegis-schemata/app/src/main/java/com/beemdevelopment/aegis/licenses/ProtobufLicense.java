...
public class ProtobufLicense extends de.psdev.licensesdialog.licenses.License {
    ...
    public java.lang.String readSummaryTextFromResources(android.content.Context context) {
        return getContent(context, com.beemdevelopment.aegis.R.raw.protobuf_license);
    }
