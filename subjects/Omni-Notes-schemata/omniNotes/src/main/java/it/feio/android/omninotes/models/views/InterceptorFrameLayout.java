...
public class InterceptorFrameLayout extends android.widget.FrameLayout {
    static final int MUID_STATIC = getMUID();
    private it.feio.android.omninotes.models.listeners.OnViewTouchedListener mOnViewTouchedListener;

    public InterceptorFrameLayout(android.content.Context context) {
        super(context);
    }


    public InterceptorFrameLayout(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    }
