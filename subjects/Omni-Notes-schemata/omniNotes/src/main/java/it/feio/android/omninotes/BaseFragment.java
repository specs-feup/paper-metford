...
public class BaseFragment extends androidx.fragment.app.Fragment {
    ...
    protected boolean isOptionsItemFastClick() {
        switch(MUID_STATIC) {
            // BaseFragment_0_BinaryMutator
            case 143: {
                if ((android.os.SystemClock.elapsedRealtime() + mLastClickTime) < it.feio.android.omninotes.BaseFragment.OPTIONS_ITEM_CLICK_DELAY_TIME) {
                    return true;
                }
                break;
            }
