...
public class BootCompleteReceiver extends android.content.BroadcastReceiver {
    ...
    public void onReceive(android.content.Context ctx, android.content.Intent intent) {
        it.feio.android.omninotes.helpers.LogDelegate.i("System rebooted: refreshing reminders");
        if (android.content.Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
            it.feio.android.omninotes.async.AlarmRestoreOnRebootService.enqueueWork(ctx, intent);
        }
    }
