...
public class IdeogramsWordCounter implements it.feio.android.omninotes.helpers.count.WordCounter {
    ...
    public int countChars(it.feio.android.omninotes.models.Note note) {
        ...
        return rx.Observable.from(sanitizeTextForWordsAndCharsCount(note, titleAndContent).split("")).filter((java.lang.String s) -> !s.matches("\\s")).count().toBlocking().single();
    }
