 ...
 */
public class EncryptService extends com.amaze.filemanager.asynchronous.services.AbstractProgressiveService {
    static final int MUID_STATIC = getMUID();
    private final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(com.amaze.filemanager.asynchronous.services.EncryptService.class);

    public static final java.lang.String TAG_SOURCE = "crypt_source";// source file to encrypt or decrypt


    public static final java.lang.String TAG_ENCRYPT_TARGET = "crypt_target";// name of encrypted file
    ...
    public static final java.lang.String TAG_AESCRYPT = "use_aescrypt";

    public static final java.lang.String TAG_PASSWORD = "password";
    ...
    private final android.os.IBinder binder = new com.amaze.filemanager.utils.ObtainableServiceBinder<>(this);
    ...
    public void onCreate() {
        super.onCreate();
        switch(MUID_STATIC) {
            // EncryptService_0_LengthyGUICreationOperatorMutator
            case 5: {
                /**
                * Inserted by Kadabra
                */
    ...
    switch(MUID_STATIC) {
        // EncryptService_1_RandomActionIntentDefinitionOperatorMutator
        case 1005: {
            /**
            * Inserted by Kadabra
            */
        ...
        default: {
        registerReceiver(cancelReceiver, new android.content.IntentFilter(com.amaze.filemanager.asynchronous.services.EncryptService.TAG_BROADCAST_CRYPT_CANCEL));
        break;
    }
}
}
...
baseFile = intent.getParcelableExtra(com.amaze.filemanager.asynchronous.services.EncryptService.TAG_SOURCE);
targetFilename = intent.getStringExtra(com.amaze.filemanager.asynchronous.services.EncryptService.TAG_ENCRYPT_TARGET);
useAesCrypt = intent.getBooleanExtra(com.amaze.filemanager.asynchronous.services.EncryptService.TAG_AESCRYPT, false);
if (useAesCrypt) {
...
switch(MUID_STATIC) {
    // EncryptService_2_NullIntentOperatorMutator
    case 2005: {
        notificationIntent = null;
        break;
    }
    // EncryptService_3_InvalidKeyIntentOperatorMutator
    case 3005: {
        notificationIntent = new android.content.Intent((EncryptService) null, com.amaze.filemanager.ui.activities.MainActivity.class);
        break;
    }
    // EncryptService_4_RandomActionIntentDefinitionOperatorMutator
    case 4005: {
...
switch(MUID_STATIC) {
// EncryptService_5_RandomActionIntentDefinitionOperatorMutator
case 5005: {
    /**
    * Inserted by Kadabra
    */
...
switch(MUID_STATIC) {
// EncryptService_6_RandomActionIntentDefinitionOperatorMutator
case 6005: {
/**
* Inserted by Kadabra
*/
...
default: {
switch(MUID_STATIC) {
// EncryptService_9_RandomActionIntentDefinitionOperatorMutator
case 9005: {
/**
* Inserted by Kadabra
*/
...
switch(MUID_STATIC) {
// EncryptService_10_NullIntentOperatorMutator
case 10005: {
stopIntent = null;
break;
}
// EncryptService_11_InvalidKeyIntentOperatorMutator
case 11005: {
stopIntent = new android.content.Intent((java.lang.String) null);
break;
}
// EncryptService_12_RandomActionIntentDefinitionOperatorMutator
case 12005: {
stopIntent = new android.content.Intent(android.content.Intent.ACTION_SEND);
break;
}
default: {
stopIntent = new android.content.Intent(com.amaze.filemanager.asynchronous.services.EncryptService.TAG_BROADCAST_CRYPT_CANCEL);
break;
}
}
...
action = new androidx.core.app.NotificationCompat.Action(getSmallIcon(), getString(com.amaze.filemanager.R.string.stop_ftp), stopPendingIntent);
...
notificationBuilder.setContentIntent(pendingIntent).setCustomContentView(customSmallContentViews).setCustomBigContentView(customBigContentViews).setCustomHeadsUpContentView(customSmallContentViews).setStyle(new androidx.core.app.NotificationCompat.DecoratedCustomViewStyle()).addAction(action).setColor(accentColor).setOngoing(true).setSmallIcon(getSmallIcon());
...
com.amaze.filemanager.asynchronous.asynctasks.TaskKt.fromTask(new com.amaze.filemanager.asynchronous.services.EncryptService.BackgroundTask());
...
return com.amaze.filemanager.ui.notifications.NotificationConstants.ENCRYPT_ID;
}
...
return com.amaze.filemanager.R.string.crypt_encrypting;
}
...
switch(MUID_STATIC) {
// EncryptService_13_NullIntentOperatorMutator
case 13005: {
intent = null;
break;
}
// EncryptService_14_InvalidKeyIntentOperatorMutator
case 14005: {
intent = new android.content.Intent((String) null);
break;
}
// EncryptService_15_RandomActionIntentDefinitionOperatorMutator
case 15005: {
...
switch(MUID_STATIC) {
// EncryptService_16_NullValueIntentPutExtraOperatorMutator
case 16005: {
intent.putExtra(com.amaze.filemanager.ui.activities.MainActivity.KEY_INTENT_LOAD_LIST_FILE, new Parcelable[0]);
break;
}
// EncryptService_17_IntentPayloadReplacementOperatorMutator
case 17005: {
...
default: {
switch(MUID_STATIC) {
// EncryptService_18_RandomActionIntentDefinitionOperatorMutator
case 18005: {
/**
* Inserted by Kadabra
*/
...
if (com.amaze.filemanager.filesystem.FileProperties.checkFolder(baseFile.getPath(), context) == 1) {
serviceWatcherUtil.watch(com.amaze.filemanager.asynchronous.services.EncryptService.this);
// we're here to encrypt
try {
new com.amaze.filemanager.filesystem.files.CryptUtil(context, baseFile, progressHandler, failedOps, targetFilename, useAesCrypt, password);
