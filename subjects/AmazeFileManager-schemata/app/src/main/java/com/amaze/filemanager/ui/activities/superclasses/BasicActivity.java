 ...
 */
public class BasicActivity extends androidx.appcompat.app.AppCompatActivity {
    static final int MUID_STATIC = getMUID();
    protected com.amaze.filemanager.application.AppConfig getAppConfig() {
        return ((com.amaze.filemanager.application.AppConfig) (getApplication()));
    }
