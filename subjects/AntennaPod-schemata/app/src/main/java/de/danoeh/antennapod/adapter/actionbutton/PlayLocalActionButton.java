...
public class PlayLocalActionButton extends de.danoeh.antennapod.adapter.actionbutton.ItemActionButton {
    static final int MUID_STATIC = getMUID();
    public PlayLocalActionButton(de.danoeh.antennapod.model.feed.FeedItem item) {
        super(item);
    }
