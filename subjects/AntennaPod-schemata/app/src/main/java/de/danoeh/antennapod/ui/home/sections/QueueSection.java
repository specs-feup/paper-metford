...
import android.util.Log;
public class QueueSection extends de.danoeh.antennapod.ui.home.HomeSection {
    static final int MUID_STATIC = getMUID();
    public static final java.lang.String TAG = "QueueSection";
    ...
    private java.util.List<de.danoeh.antennapod.model.feed.FeedItem> queue = new java.util.ArrayList<>();
    ...
    android.os.Bundle savedInstanceState) {
        ...
        listAdapter = new de.danoeh.antennapod.adapter.HorizontalItemListAdapter(((de.danoeh.antennapod.activity.MainActivity) (getActivity()))) {
            ...
            public void onCreateContextMenu(android.view.ContextMenu menu, android.view.View v, android.view.ContextMenu.ContextMenuInfo menuInfo) {
                ...
                de.danoeh.antennapod.core.menuhandler.MenuItemUtils.setOnClickListeners(menu, de.danoeh.antennapod.ui.home.sections.QueueSection.this::onContextItemSelected);
            }

        };
        listAdapter.setDummyViews(de.danoeh.antennapod.ui.home.sections.QueueSection.NUM_EPISODES);
...
protected void handleMoreClick() {
    ((de.danoeh.antennapod.activity.MainActivity) (requireActivity())).loadChildFragment(new de.danoeh.antennapod.fragment.QueueFragment());
}
...
public void onEventMainThread(de.danoeh.antennapod.event.FeedItemEvent event) {
    android.util.Log.d(de.danoeh.antennapod.ui.home.sections.QueueSection.TAG, (("onEventMainThread() called with: " + "event = [") + event) + "]");
    if (queue == null) {
        return;
    }
...
public void onEventMainThread(de.danoeh.antennapod.event.playback.PlaybackPositionEvent event) {
    ...
    boolean foundCurrentlyPlayingItem;
    foundCurrentlyPlayingItem = false;
    boolean currentlyPlayingItemIsFirst;
    currentlyPlayingItemIsFirst = true;
...
protected java.lang.String getSectionTitle() {
    return getString(de.danoeh.antennapod.R.string.home_continue_title);
}


@java.lang.Override
protected java.lang.String getMoreLinkTitle() {
    return getString(de.danoeh.antennapod.R.string.queue_label);
}
...
private void loadItems() {
    ...
    disposable = io.reactivex.Observable.fromCallable(() -> de.danoeh.antennapod.core.storage.DBReader.getPausedQueue(de.danoeh.antennapod.ui.home.sections.QueueSection.NUM_EPISODES)).subscribeOn(io.reactivex.schedulers.Schedulers.io()).observeOn(io.reactivex.android.schedulers.AndroidSchedulers.mainThread()).subscribe((java.util.List<de.danoeh.antennapod.model.feed.FeedItem> queue) -> {
        this.queue = queue;
        listAdapter.setDummyViews(0);
        listAdapter.updateData(queue);
    }, (java.lang.Throwable error) -> android.util.Log.e(de.danoeh.antennapod.ui.home.sections.QueueSection.TAG, android.util.Log.getStackTraceString(error)));
}
