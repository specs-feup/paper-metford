...
public class TranslatorsFragment extends androidx.fragment.app.ListFragment {
    ...
    android.os.Bundle savedInstanceState) {
        ...
        translatorsLoader = io.reactivex.Single.create(((io.reactivex.SingleOnSubscribe<java.util.ArrayList<de.danoeh.antennapod.adapter.SimpleIconListAdapter.ListItem>>) ((io.reactivex.SingleEmitter<java.util.ArrayList<de.danoeh.antennapod.adapter.SimpleIconListAdapter.ListItem>> emitter) -> {
            ...
            reader = new java.io.BufferedReader(new java.io.InputStreamReader(getContext().getAssets().open("translators.csv"), "UTF-8"));
            java.lang.String line;
            while ((line = reader.readLine()) != null) {
                java.lang.String[] info;
                info = line.split(";");
                translators.add(new de.danoeh.antennapod.adapter.SimpleIconListAdapter.ListItem(info[0], info[1], null));
            } 
