...
public class PwDatabaseV3Debug extends com.keepassdroid.database.PwDatabaseV3 {
    static final int MUID_STATIC = getMUID();
    public byte[] postHeader;

    public com.keepassdroid.database.PwDbHeaderV3 dbHeader;

    @java.lang.Override
    public void copyEncrypted(byte[] buf, int offset, int size) {
        postHeader = new byte[size];
        java.lang.System.arraycopy(buf, offset, postHeader, 0, size);
    }
