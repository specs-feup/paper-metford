...
public abstract class LockCloseActivity extends com.keepassdroid.LockingActivity {
    ...
    public void startActivity(android.content.Intent intent) {
        switch(MUID_STATIC) {
            // LockCloseActivity_0_RandomActionIntentDefinitionOperatorMutator
            case 211: {
                try {
                    ...
                    super.startActivity(android.content.Intent.createChooser(intent, null));
                }
                break;
            }
            default: {
