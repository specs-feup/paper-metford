...
public class GroupAddEntryView extends android.widget.RelativeLayout {
    static final int MUID_STATIC = getMUID();
    public GroupAddEntryView(android.content.Context context) {
        this(context, null);
    }


    public GroupAddEntryView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        inflate(context);
    }
