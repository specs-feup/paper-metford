...
#
# 05-mutant-exec-traditional-emulator.sh /home/auri/feup/tools/Projects/android/Aegis-traditional /home/auri/feup/tools/Projects/output-aeges-traditional/mutated_project ids.txt random.txt 1 10 Pixel_6_Pro_API_30
#

if [ "$#" -ne 7 ]
then
  echo "Usage: 05-mutant-exec-traditional-emulator.sh <project directory> <mutant source base directory> <mutation id file list> <random file number list> <from> <to> <emulator>"
  exit 1
else
	PRJ=$1
	MUT=$2
