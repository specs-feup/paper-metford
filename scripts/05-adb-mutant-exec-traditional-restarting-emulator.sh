...
# Aegis example
#
# 05-adb-mutant-exec-traditional-restarting-emulator.sh /home/auri/feup/tools/Projects/android/Aegis-traditional /home/auri/feup/tools/Projects/output-aeges-traditional/mutated_project assemble app/build/outputs/apk/debug/app-debug.apk assembleAndroidTest app/build/outputs/apk/androidTest/debug/app-debug-androidTest.apk ids.txt random.txt test-case-names.txt com.beemdevelopment.aegis.debug.test/com.beemdevelopment.aegis.AegisTestRunner fullFail Pixel_6_Pro_API_30 app 5 1 10
#
# AntennaPod example
#
# 05-adb-mutant-exec-traditional-restarting-emulator.sh /home/auri/feup/tools/Projects/android/AntennaPod-traditional /home/auri/feup/tools/Projects/output-antennapod-traditional/mutated_project assembleFreeDebug app/build/outputs/apk/free/debug/app-free-debug.apk assembleAndroidTest app/build/outputs/apk/androidTest/free/debug/app-free-debug-androidTest.apk ids.txt random.txt test-case-names.txt de.danoeh.antennapod.core.tests/androidx.test.runner.AndroidJUnitRunner fullFail Pixel_6_Pro_API_30 app 5 1 10
#
# Omni-Notes example
#
# ~/feup/tools/scripts-kadabra/05-adb-mutant-exec-traditional-restarting-emulator.sh /home/auri/feup/tools/Projects/android/Omni-Notes-traditional /home/auri/feup/tools/Projects/output-omni-notes-traditional/mutated_project assembleFossDebug omniNotes/build/outputs/apk/foss/debug/OmniNotes-fossDebug-6.2.8.apk assembleFossDebugAndroidTest omniNotes/build/outputs/apk/androidTest/foss/debug/omniNotes-foss-debug-androidTest.apk ids.txt sequence.txt test-case-names.txt it.feio.android.omninotes.foss.test/androidx.test.runner.AndroidJUnitRunner fullFail Pixel_6_Pro_API_30 omniNotes 5 1 322 
#

if [ "$#" -ne 16 ]
then
  echo "Usage: 05-adb-mutant-exec-traditional-restarting-emulator.sh <project directory> <mutant source base directory> <app build task> <app apk> <android test build task> <android test apk> <mutation id file list> <random file number list> <test case list> <package/test executor> <fastFail|fullFail> <emulator> <main app dir name> <timeout in minutes> <from> <to>"
  exit 1
else
	# Script parameters
	PRJ=$1
